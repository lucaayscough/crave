...
void v1_load_weights(arena_t* arena, v1_model_weights_t* weights) {
  ...
  weights->noise = crv_tensor_load_from_file(arena, V1_BIN_PATH"pre_process_latent_noise.bin", CRV_TENSOR_AUTO_CAP);
  weights->latent_pca = crv_tensor_load_from_file(arena, V1_BIN_PATH"pre_process_latent_latent_pca.bin", CRV_TENSOR_AUTO_CAP);
  weights->latent_mean = crv_tensor_load_from_file(arena, V1_BIN_PATH"pre_process_latent_latent_mean.bin", CRV_TENSOR_AUTO_CAP);
  weights->pqmf_inverse_conv_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"pqmf.inverse_conv.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->net_0_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.0.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->net_1_alpha = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.1.alpha.bin", CRV_TENSOR_AUTO_CAP);
  weights->net_2_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.2.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->decoder_net_3_aligned_branches_0_net_1_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.3.aligned.branches.0.net.1.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->decoder_net_3_aligned_branches_0_net_3_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.3.aligned.branches.0.net.3.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->decoder_net_4_aligned_branches_0_net_1_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.4.aligned.branches.0.net.1.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->decoder_net_4_aligned_branches_0_net_3_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.4.aligned.branches.0.net.3.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->net_5_alpha = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.5.alpha.bin", CRV_TENSOR_AUTO_CAP);
  weights->net_6_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.6.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->decoder_net_7_aligned_branches_0_net_1_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.7.aligned.branches.0.net.1.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->decoder_net_7_aligned_branches_0_net_3_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.7.aligned.branches.0.net.3.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->decoder_net_8_aligned_branches_0_net_1_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.8.aligned.branches.0.net.1.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->decoder_net_8_aligned_branches_0_net_3_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.8.aligned.branches.0.net.3.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->decoder_net_9_aligned_branches_0_net_1_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.9.aligned.branches.0.net.1.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->decoder_net_9_aligned_branches_0_net_3_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.9.aligned.branches.0.net.3.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->net_10_alpha = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.10.alpha.bin", CRV_TENSOR_AUTO_CAP);
  weights->net_11_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.11.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->decoder_net_12_aligned_branches_0_net_1_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.12.aligned.branches.0.net.1.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->decoder_net_12_aligned_branches_0_net_3_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.12.aligned.branches.0.net.3.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->decoder_net_13_aligned_branches_0_net_1_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.13.aligned.branches.0.net.1.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->decoder_net_13_aligned_branches_0_net_3_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.13.aligned.branches.0.net.3.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->decoder_net_14_aligned_branches_0_net_1_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.14.aligned.branches.0.net.1.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->decoder_net_14_aligned_branches_0_net_3_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.14.aligned.branches.0.net.3.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->net_15_alpha = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.15.alpha.bin", CRV_TENSOR_AUTO_CAP);
  weights->net_16_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.16.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->decoder_net_17_aligned_branches_0_net_1_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.17.aligned.branches.0.net.1.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->decoder_net_17_aligned_branches_0_net_3_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.17.aligned.branches.0.net.3.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->decoder_net_18_aligned_branches_0_net_1_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.18.aligned.branches.0.net.1.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->decoder_net_18_aligned_branches_0_net_3_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.18.aligned.branches.0.net.3.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->decoder_net_19_aligned_branches_0_net_1_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.19.aligned.branches.0.net.1.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->decoder_net_19_aligned_branches_0_net_3_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.19.aligned.branches.0.net.3.weight.bin", CRV_TENSOR_AUTO_CAP);
  weights->net_20_alpha = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.20.alpha.bin", CRV_TENSOR_AUTO_CAP);
  weights->net_21_weight = crv_tensor_load_from_file(arena, V1_BIN_PATH"decoder.net.21.weight.bin", CRV_TENSOR_AUTO_CAP);

  weights->skip = crv_tensor_create(arena, CRV_TPL(1), 2 * 1024);
  weights->mask = crv_tensor_create(arena, CRV_TPL(1, 16, 128), CRV_TENSOR_AUTO_CAP);
  crv_tensor_fill(weights->mask, 1.f);
  ...
  crv_tensor_unsqueeze(weights->latent_pca, weights->latent_pca->rank);
  crv_tensor_transpose(weights->latent_pca, 0, 1);
  crv_tensor_unsqueeze(weights->latent_mean, 0);
  crv_tensor_unsqueeze(weights->latent_mean, weights->latent_mean->rank);
}
