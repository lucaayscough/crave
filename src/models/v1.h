...
void load_weights(arena_t* arena, v1_model_weights_t* weights) {
  ...
  weights->noise = tensor_load_from_file(arena, BIN_PATH"pre_process_latent_noise.bin", TENSOR_AUTO_CAP);
  weights->latent_pca = tensor_load_from_file(arena, BIN_PATH"pre_process_latent_latent_pca.bin", TENSOR_AUTO_CAP);
  weights->latent_mean = tensor_load_from_file(arena, BIN_PATH"pre_process_latent_latent_mean.bin", TENSOR_AUTO_CAP);
  weights->pqmf_inverse_conv_weight = tensor_load_from_file(arena, BIN_PATH"pqmf.inverse_conv.weight.bin", TENSOR_AUTO_CAP);
  weights->net_0_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.0.weight.bin", TENSOR_AUTO_CAP);
  weights->net_1_alpha = tensor_load_from_file(arena, BIN_PATH"decoder.net.1.alpha.bin", TENSOR_AUTO_CAP);
  weights->net_2_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.2.weight.bin", TENSOR_AUTO_CAP);
  weights->decoder_net_3_aligned_branches_0_net_1_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.3.aligned.branches.0.net.1.weight.bin", TENSOR_AUTO_CAP);
  weights->decoder_net_3_aligned_branches_0_net_3_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.3.aligned.branches.0.net.3.weight.bin", TENSOR_AUTO_CAP);
  weights->decoder_net_4_aligned_branches_0_net_1_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.4.aligned.branches.0.net.1.weight.bin", TENSOR_AUTO_CAP);
  weights->decoder_net_4_aligned_branches_0_net_3_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.4.aligned.branches.0.net.3.weight.bin", TENSOR_AUTO_CAP);
  weights->net_5_alpha = tensor_load_from_file(arena, BIN_PATH"decoder.net.5.alpha.bin", TENSOR_AUTO_CAP);
  weights->net_6_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.6.weight.bin", TENSOR_AUTO_CAP);
  weights->decoder_net_7_aligned_branches_0_net_1_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.7.aligned.branches.0.net.1.weight.bin", TENSOR_AUTO_CAP);
  weights->decoder_net_7_aligned_branches_0_net_3_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.7.aligned.branches.0.net.3.weight.bin", TENSOR_AUTO_CAP);
  weights->decoder_net_8_aligned_branches_0_net_1_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.8.aligned.branches.0.net.1.weight.bin", TENSOR_AUTO_CAP);
  weights->decoder_net_8_aligned_branches_0_net_3_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.8.aligned.branches.0.net.3.weight.bin", TENSOR_AUTO_CAP);
  weights->decoder_net_9_aligned_branches_0_net_1_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.9.aligned.branches.0.net.1.weight.bin", TENSOR_AUTO_CAP);
  weights->decoder_net_9_aligned_branches_0_net_3_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.9.aligned.branches.0.net.3.weight.bin", TENSOR_AUTO_CAP);
  weights->net_10_alpha = tensor_load_from_file(arena, BIN_PATH"decoder.net.10.alpha.bin", TENSOR_AUTO_CAP);
  weights->net_11_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.11.weight.bin", TENSOR_AUTO_CAP);
  weights->decoder_net_12_aligned_branches_0_net_1_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.12.aligned.branches.0.net.1.weight.bin", TENSOR_AUTO_CAP);
  weights->decoder_net_12_aligned_branches_0_net_3_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.12.aligned.branches.0.net.3.weight.bin", TENSOR_AUTO_CAP);
  weights->decoder_net_13_aligned_branches_0_net_1_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.13.aligned.branches.0.net.1.weight.bin", TENSOR_AUTO_CAP);
  weights->decoder_net_13_aligned_branches_0_net_3_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.13.aligned.branches.0.net.3.weight.bin", TENSOR_AUTO_CAP);
  weights->decoder_net_14_aligned_branches_0_net_1_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.14.aligned.branches.0.net.1.weight.bin", TENSOR_AUTO_CAP);
  weights->decoder_net_14_aligned_branches_0_net_3_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.14.aligned.branches.0.net.3.weight.bin", TENSOR_AUTO_CAP);
  weights->net_15_alpha = tensor_load_from_file(arena, BIN_PATH"decoder.net.15.alpha.bin", TENSOR_AUTO_CAP);
  weights->net_16_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.16.weight.bin", TENSOR_AUTO_CAP);
  weights->decoder_net_17_aligned_branches_0_net_1_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.17.aligned.branches.0.net.1.weight.bin", TENSOR_AUTO_CAP);
  weights->decoder_net_17_aligned_branches_0_net_3_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.17.aligned.branches.0.net.3.weight.bin", TENSOR_AUTO_CAP);
  weights->decoder_net_18_aligned_branches_0_net_1_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.18.aligned.branches.0.net.1.weight.bin", TENSOR_AUTO_CAP);
  weights->decoder_net_18_aligned_branches_0_net_3_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.18.aligned.branches.0.net.3.weight.bin", TENSOR_AUTO_CAP);
  weights->decoder_net_19_aligned_branches_0_net_1_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.19.aligned.branches.0.net.1.weight.bin", TENSOR_AUTO_CAP);
  weights->decoder_net_19_aligned_branches_0_net_3_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.19.aligned.branches.0.net.3.weight.bin", TENSOR_AUTO_CAP);
  weights->net_20_alpha = tensor_load_from_file(arena, BIN_PATH"decoder.net.20.alpha.bin", TENSOR_AUTO_CAP);
  weights->net_21_weight = tensor_load_from_file(arena, BIN_PATH"decoder.net.21.weight.bin", TENSOR_AUTO_CAP);
...
void decode(tensor_t* z, v1_model_weights_t* w) {
